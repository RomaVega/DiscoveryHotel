...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Boutique seafront hotel in Candidasa, Karangasem. Pool villas, tropical gardens, Ayurvedic spa, and oceanfront dining. 5-star Balinese hospitality away from the crowds.",
    url: `${SITE_URL}/about`,
    images: [{ url: `${SITE_URL}/images/welcome/welcome-garden-path-ocean-candidasa.webp`, width: 1200, height: 630 }],
  },
};
...
export default function AboutPage() {
  ...
  return (
    <InnerPageLayout contact={contact}>
      ...
      <PageHero
        image="/images/welcome/welcome-garden-path-ocean-candidasa.webp"
