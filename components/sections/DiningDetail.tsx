...
export function DiningDetail({ data }: DiningDetailProps) {
  ...
  return (
    <div>
      ...
      <div className="bg-ivory py-20 md:py-32">
          ...
          {data.features.map((feature, i) => (
            <FadeIn key={i}>
              <div className={`flex flex-col lg:flex-row items-stretch ${i % 2 === 1 ? "lg:flex-row-reverse" : ""}`}>
                ...
                {/* Text */}
                <div className="lg:w-1/2 bg-sand flex flex-col justify-center px-10 md:px-16 lg:px-20 py-14">
      ...
      {data.menuHighlights && data.menuHighlights.length > 0 && (
        <FadeIn>
          <div className="bg-ivory py-20 md:py-28 px-6 border-t border-charcoal/8">
            {/* Section title */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-charcoal/10 border-t border-charcoal/8">
            ...
            >
              ...
              <div>
                ...
                <p className="text-stone/60 text-xs mt-1 leading-relaxed">
                  {isRu ? "Через WhatsApp" : "Via WhatsApp"}
                </p>
              </div>
