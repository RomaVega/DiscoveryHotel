 ...
 */
export function BookNowButton({ className, onClick }: BookNowButtonProps) {
  ...
  return (
    <a
      ...
      className={cn(
        ...
        "bg-gradient-to-b from-brand-teal to-cta-teal",
        ...
        "shadow-[0_0_0_1px_rgba(255,255,255,0.65),0_2px_6px_rgba(0,0,0,0.16),0_8px_24px_rgba(0,0,0,0.18)]",
        className
      )}
    >
