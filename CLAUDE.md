...
scripts/                # check-images.js, check-links.js, generate-image-manifest.js
```
...
- **PrimaryButton:** `bg-brand-teal hover:bg-deep-teal hover:scale-[1.04] active:scale-[0.97] text-white font-sans font-semibold px-8 py-3 rounded-full tracking-wide uppercase text-sm transition-colors duration-300` + focus-visible ring. See [components/common/PrimaryButton.tsx](components/common/PrimaryButton.tsx) — supports `href` and `external`.
